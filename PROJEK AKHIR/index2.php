          ...
          <div class="row align-items-center">
            ...
            <form method="POST" action="cek_register.php">
                ...
                <?php 
                    if(isset($_GET['pesan']))
                    {
                    if ($_GET['pesan'] == "username_exists") echo "Signup gagal!  Username telah digunakan!";
                    else if($_GET['pesan'] == "password_kurang") echo "Signup gagal!  password harus terdiri dari 8 karakter!";
                    else if ($_GET['pesan'] == "password_missmatch") echo "Signup gagal!  kedua password harus sama!";
                        }
                    ?>

                <div class="input-group mb-2" style="margin-top: 10%;">
                    <button class="btn btn-lg btn-oren w-100 fs-6" type="submit">Register</button>
                </div>
            </form>
